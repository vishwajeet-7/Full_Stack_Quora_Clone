  ...
  return (
    ...
    >
      <Stack margin={"0px auto"}>
        <svg width="180px" height="115px" viewBox="0 0 202 115">
      ...
      <p style={{ fontWeight: "bold", marginTop: "-22px" }}>
        A place to share knowledge and better understand the world
      </p>
      <Flex justify={"space-around"}>
        <Stack w={"50%"} p={"2rem"} gap={4}>
          <Text fontSize={"14px"} textAlign={"left"}>
            By continuing you indicate that you agree to Quora’s Terms of
            Service and Privacy Policy.
          </Text>
          <Flex border={"1px solid grey"} alignItems={'center'} p={'0 1rem'}>
            <FcGoogle fontSize={'22px'}/>
            <Button bg={"none"}>Continue with Google</Button>
          </Flex>
          <Flex border={"1px solid grey"} alignItems={'center'} p={'0 1rem'}>
            <BsFacebook fontSize={'22px'} color="#1877f2"/>
            <Button bg={"none"}>Continue with Google</Button>
          </Flex>
          <Button bg={"none"}>Sign up with email</Button>
        </Stack>
        <Divider orientation="vertical" borderColor={'grey'}/>
        <Stack w={"50%"} p={"2rem"}>
          <Text fontSize={'16px'} fontWeight={'bold'} textAlign={'left'}>Login</Text>
          ...
          <Flex justify={"space-between"} alignItems={"center"}>
            <Text mt={"15px"} fontSize={'12px'}>Forgot password?</Text>
            <Button
              mt={"15px"}
              bg={"#1877f2"}
              color={"white"}
          ...
          <Text textAlign={'left'} fontSize={'16px'} color={'#1877f2'} bg={'#ebf0ff'}>
          You are now logged out of this browser, but are still logged in with other browsers. <span style={{textDecoration:'underline'}}>Log out of all browsers.</span>
          </Text>
        </Stack>
      </Flex>
      <Divider borderColor={'grey'}/>
      <Center color={'blue'}>हिन्दी <IoIosArrowForward/> </Center>
      <Divider borderColor={'grey'}/>
      <Flex p={'0 20px'} alignItems={'center'}>
        <Text fontSize={'13px'}>About</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Careers</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Privacy</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Terms</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Contact</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Languages</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Your Ad Choices</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Press</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Quora</Text>
        <BsDot/>
        <Text fontSize={'13px'}>Inc.2023</Text>
      </Flex>
    </Stack>
  );
};
