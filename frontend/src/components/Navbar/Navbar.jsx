...
import { SlUserFollowing, SlPeople, SlBell, SlGlobe } from "react-icons/sl";
...
const Navbar = () => {
  return (
    ...
    >
      <Stack>
        <svg width="100px" height="50px" viewBox="0 0 202 115">
          <g
            stroke="none"
            fill="
#b92b27"
      ...
      <SlUserFollowing fontSize={"30px"} />
      <FaEdit fontSize={"30px"} />
      <SlPeople fontSize={"30px"} />
      <SlBell fontSize={"30px"} />
      <InputGroup w={"300px"}>
        <InputLeftElement
          pointerEvents="none"
          children={<IoIosSearch fontSize={"20px"} />}
        />
        <Input type="tel" placeholder="Search Quora" />
      </InputGroup>
      <Button borderRadius={'20px'}>Try Quora+</Button>
      <AvatarMenu/>
      <SlGlobe fontSize={"30px"} />
      <AddQuestions />
    </Flex>
  );
};
